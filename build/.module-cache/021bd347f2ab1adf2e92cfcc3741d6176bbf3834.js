        ...
        var dataHtml = this.state.dataList.map(function (orderInfo) {
            return (React.createElement("tr", null, 
                ...
                React.createElement("td", null, 
                    ...
                    React.createElement(Button, {bsStyle: "primary", bsSize: "xsmall", 
                            onClick: this.versionDelSubmit.bind(this,orderInfo.orderId)}, "转到")
                )
                ...
                React.createElement(Row, null, 
                    React.createElement(Table, {striped: true, condensed: true, hover: true, className: "tablelist"}, 
                        ...
                        React.createElement("tr", null, 
                            ...
                            React.createElement("th", {style: {width: fourWordsWidth}}, "操作")
                        )
                        ), 
