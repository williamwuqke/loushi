...
var TablePanel = React.createClass({displayName: "TablePanel",
    ...
    loadTableDataFromServer: function (tabPage, currentBankId) {
    ...
    componentWillReceiveProps: function (nextProps) {
        if (this.props.tabPage != nextProps.tabPage || this.props.currentBankId != nextProps.currentBankId) {
            this.loadTableDataFromServer(nextProps.tabPage, nextProps.currentBankId);
        }
    },
    ...
    render : function(){
        var dataHtml = this.props.dataList.map(function (versionInfo) {
            return (React.createElement("tr", null, 
                ...
                React.createElement("td", null, 
                    React.createElement(Button, {bsStyle: "info", bsSize: "xsmall", 
                            onClick: this.versionEditOpen.bind(this,versionInfo.version_id)}, "编辑"), 
                    "  ", 
                    React.createElement(Button, {bsStyle: "warning", bsSize: "xsmall", 
                            onClick: this.versionDelSubmit.bind(this,versionInfo.version_id)}, "删除")
                )
